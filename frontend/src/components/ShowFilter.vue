      ...
      <v-card>
        <v-card-text>
          <div class="text-center d-flex pb-4" style="float: right">
            ...
            >
              <v-icon>{{
                isfilterOpen ? "mdi-arrow-expand-down" : "mdi-arrow-expand-up"
              }}</v-icon>
            </v-btn>
          </div>
                    ...
                    <v-row no-gutters>
                      ...
                      <v-col cols="8" class="text--secondary">
                        <v-fade-transition leave-absolute>
                          ...
                          <span v-else key="1">
                            <div v-if="distance != 0">{{ distance }} km</div>
                            <div v-else>
                              {{ distanceTozero() }}
                            </div>
                          </span>
          ...
          <div style="text-align: center">
            ...
            <v-btn class="mx-1" :disabled="refreshDisabled" @click="refresh">
